...
#define TL_REQUIRES(...)                                                                       \
    requires(::atem::tl_detail::nth_arg_t<0, TlArgs...> _1 [[maybe_unused]],                        \
             ::atem::tl_detail::nth_arg_t<1, TlArgs...> _2 [[maybe_unused]],                        \
             ::atem::tl_detail::nth_arg_t<2, TlArgs...> _3 [[maybe_unused]],                        \
             ::atem::tl_detail::nth_arg_t<3, TlArgs...> _4 [[maybe_unused]]) {                      \
        __VA_ARGS__;                                                                               \
    }
// clang-format on
...
#define CTL(...)                                                                               \
    <typename... TlArgs>(TlArgs && ... _args)                                                      \
        ...
        [[maybe_unused]] auto&& _1 = ::atem::tl_detail::nth_arg<0>(FWD(_args)...);              \
        [[maybe_unused]] auto&& _2 = ::atem::tl_detail::nth_arg<1>(FWD(_args)...);              \
        [[maybe_unused]] auto&& _3 = ::atem::tl_detail::nth_arg<2>(FWD(_args)...);              \
        [[maybe_unused]] auto&& _4 = ::atem::tl_detail::nth_arg<3>(FWD(_args)...);              \
        return (__VA_ARGS__);                                                                      \
    }
#else
#define CTL(...)                                                                               \
